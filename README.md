...
- `6060戰法`：用 Yahoo chart API 抓取最近 3 個月 60 分鐘 K 線；日線均線需呈多頭排列，60分K 的 60MA 必須向上，60分 MACD 位於零軸上。進場以放量突破 60分60MA 為確認，回踩 60分60MA 不破列為轉強觀察。
...
- 每日另產生「回後買上漲 Top 10」、「底部起漲 Top 10」、「處置反彈 Top 10」、「搶反彈 Top 10」、「布林收斂 Top 10」、「6060戰法 Top 10」、「低檔高殖利率 Top 10」及「Lorentzian ML Top 10」；確認固定優先，底部起漲以離 60 日低點遠近、20 日整理區間、整理量縮、突破量能與結構風險排序，處置反彈以中探針型態相似度、急跌日、偏離20MA、低檔爆量與止跌 K 風險排序，搶反彈以跌幅、低檔爆量、止跌 K 風險與是否突破止跌 K 高點排序，6060戰法以日線均線多頭排列、距60分60MA遠近、60分60MA上彎、MACD零軸上與放量突破排序，低檔高殖利率以殖利率、離低點遠近、從高點回落、P/B 與成交張數排序，Lorentzian ML 以 AI Edge port 對齊後的近鄰投票、信心、Kernel 斜率、相對強度與結構風險排序。
