...
- `60分K近60MA`：用 Yahoo chart API 抓取最近 3 個月 60 分鐘 K 線，計算 60MA；日成交量需大於 2000 張，且最新 60 分K 收盤距 60MA 在 ±1.5% 內，站上60MA且斜率不弱者優先。
...
- 每日另產生「回後買上漲 Top 10」、「盤整突破 Top 10」、「處置反彈 Top 10」、「搶反彈 Top 10」、「布林收斂 Top 10」、「60分K近60MA Top 10」、「低檔高殖利率 Top 10」及「Lorentzian ML Top 10」；確認固定優先，處置反彈以中探針型態相似度、急跌日、偏離20MA、低檔爆量與止跌 K 風險排序，搶反彈以跌幅、低檔爆量、止跌 K 風險與是否突破止跌 K 高點排序，60分K近60MA 以距60MA遠近、60MA斜率與日成交張數排序，低檔高殖利率以殖利率、離低點遠近、從高點回落、P/B 與成交張數排序，Lorentzian ML 以 AI Edge port 對齊後的近鄰投票、信心、Kernel 斜率、相對強度與結構風險排序。
